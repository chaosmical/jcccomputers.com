...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>JCC Computers - About Us Us</title>
...
?>
			...
			<ul id="nav">
				<li><a href="/">Home</a></li>
				<li><a class="selected" href="about_us.php">About Us</a></li>
			...
			<div id="content">
				<h1>About JCC Computers</h1>
				<p>JCC Computers was formed as a natural progression of Jerry's training in working with computers, and wanting to offer his knowledge and expertise for the benefit of others. At the time, there was also a very high demand for quality, onsite service, as most computer services businesses only offered in shop consultations. A few years later, JCC is going strong, providing high quality work and customer care. We value our relationship with our clients and ensure their complete satisfaction with our services.</p>
				<div id="push"></div>
			</div>
		</div>
		<div id="footer">
